...
## Architecture
- **Input:** Game state (player position, raycasts to obstacles/rewards, etc.)
...
- **+10** for collecting a reward (e.g., apple)
- **-10** for hitting an enemy (e.g., snail) or falling
- **-0.01** small time penalty per step to encourage faster completion
- **+50** for reaching the end goal
...
- `target_update`: How often the Target Network syncs with the Policy Network
